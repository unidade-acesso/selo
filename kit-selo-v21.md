...
Para a atribuição do Selo Bronze, o sítio _Web_ tem de cumprir com os requisitos constantes da lista de verificação "Conteúdo" e ainda passar a bateria de testes de um validador de acessibilidade _Web_ para o ‘AA’ das WCAG 2.1, de acordo com a metodologia constante no artigo 9.º, n.º 1, alínea a) do DL nº 83/2018, de 19 de outubro.

O nível de cumprimento desses parâmetros durante o primeiro ano deverá ser de 75%. 

### Nível 2 - Selo Prata

Para a atribuição do Selo Prata, cumulativamente ao que é exigido para o nível 1, o sítio _Web_ tem de estar em conformidade para com a lista de verificação de usabilidade "Transação" e da lista de acessibilidade "10 aspetos funcionais".
...
Qualquer utilizador que acione a hiperligação existente no Selo será direcionado para o sítio _Web_ do Selo (https://www.selodeusabilidade.gov.pt) onde poderá comprovar a autenticidade do mesmo. 
...
Nota: a entidade deve preencher esta checklist, publicá-la no sítio _Web_, e disponibilizar um _link_ para a mesma na Declaração de Acessibilidade e Usabilidade. Deve igualmente disponibilizar um relatório que evidencie a prova para cada um dos aspetos assinalados com "Sim" na lista de verificação.

<table>
<caption>10 aspetos críticos de acessibilidade - Lista de verificação para sítios <em>Web</em></caption>
 <tbody><tr>
 ...
 <tr>
  <th align="left">5. Para <strong>gráficos e imagens-<em>link</em></strong>, verifique se:</th>
  <th>sim</th>
  <th>não</th>
  <th><abbr title="Não aplicável">n.a.</abbr></th>
 </tr>
...
<table>
<caption>Conteúdo - Lista de verificação para sítios <em>Web</em></caption>
<tbody><tr>
<th align="left">1. Para <strong>clareza do conteúdo</strong>, verifique se:</th>
<Th>sim</th>
  <Th>não</th>
  <th><abbr title="Não aplicável">n.a.</abbr></th>
 </tr>
<tr>
<td>O site apresenta um resumo breve do seu propósito, visível sem se fazer <em>scroll</em></td>
<td></td>
<td></td>
<td></td>
</tr>
...
<tr>
<th align="left">2. Para <strong>usabilidade do conteúdo</strong>, verifique se:</th>
<Th>sim</th>
  <Th>não</th>
  <th><abbr title="Não aplicável">n.a.</abbr></th>
 </tr>
...
<tr>
<th align="left">3. Para <strong>estrutura da navegação</strong>, verifique se:</th>
<Th>sim</th>
  <Th>não</th>
  <th><abbr title="Não aplicável">n.a.</abbr></th>
 </tr>
...
<tr>
<th align="left">4. Para <strong>estrutura da informação</strong>, verifique se:</th>
<Th>sim</th>
  <Th>não</th>
  <th><abbr title="Não aplicável">n.a.</abbr></th>
 </tr>
...
<tr>
<th align="left">5. Para <strong>elementos interativos</strong>, verifique se:</th>
<Th>sim</th>
  <Th>não</th>
  <th><abbr title="Não aplicável">n.a.</abbr></th>
 </tr>
...
<table>
<caption>Transação - Lista de verificação para sítios <em>Web</em></caption>
 <tbody><tr>
  <th align="left">1. Para <strong>formulários</strong>, verifique se:</th>
  <Th>sim</th>
  <Th>não</th>
  <th><abbr title="Não aplicável">n.a.</abbr></th>
 </tr>
...
<tr>
<th align="left">2. Para <strong>campos</strong>, verifique se:</th>
  <Th>sim</th>
  <Th>não</th>
  <th><abbr title="Não aplicável">n.a.</abbr></th>
 </tr>
...
<tr>
<th align="left">3. Para <strong>resposta</strong>, verifique se:</th>
  <Th>sim</th>
  <Th>não</th>
  <th><abbr title="Não aplicável">n.a.</abbr></th>
 </tr>
...
<tr>
<th align="left">4. Para <strong>erros</strong>, verifique se:</th>
  <Th>sim</th>
  <Th>não</th>
  <th><abbr title="Não aplicável">n.a.</abbr></th>
 </tr>
